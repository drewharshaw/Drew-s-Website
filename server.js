...
app.get("/images/unavailable-image.jpg", (req, res) => {
  res.sendFile(
    path.resolve(__dirname, "public", "images", "unavailable-image.jpg")
  );
});
...
app.get("/images/queensLogo.svg", (req, res) => {
  res.sendFile(path.resolve(__dirname, "public", "images", "queensLogo.svg"));
});

app.get("/images/ericsson-icon.svg", (req, res) => {
  res.sendFile(
    path.resolve(__dirname, "public", "images", "ericsson-icon.svg")
  );
});

app.get("/images/walker-industries-logo.png", (req, res) => {
  res.sendFile(
    path.resolve(__dirname, "public", "images", "walker-industries-logo.png")
  );
});
