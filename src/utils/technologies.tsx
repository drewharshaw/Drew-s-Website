...
function Arduino() {
    return(
        <SvgIcon>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><path d="M24 24.332S29 16 35.664 16C40.25 16 44 19.75 44 24.332c0 4.582-3.75 8.332-8.336 8.332C29 32.664 24 24.332 24 24.332zM24 24.332s-5 8.332-11.668 8.332C7.75 32.664 4 28.914 4 24.332 4 19.75 7.75 16 12.332 16 19.168 16 24 24.332 24 24.332z" fill="none" strokeWidth="4" stroke="#009688" strokeMiterlimit="10"/><path d="M10 23h6.004v2H10zM32 23h6.004v2H32z" fill="#009688"/><path d="M34 21h2v6h-2z" fill="#009688"/></svg>
        </SvgIcon>
    );
}
